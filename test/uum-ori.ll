...
@array_global = dso_local global ptr null, align 8
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [12 x i8] c"ok, no uum\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_uum.cc, ptr null }]
...
define internal void @__cxx_global_var_init.1() #0 section ".text.startup" {
  %1 = call noalias ptr @malloc(i64 noundef 492) #6
  store ptr %1, ptr @array_global, align 8
  ret void
}
...
define dso_local noundef i32 @main() #5 {
  ...
  %4 = call noalias ptr @malloc(i64 noundef 132) #6
  store ptr %4, ptr %2, align 8
  %5 = load ptr, ptr %2, align 8
  %6 = getelementptr inbounds i32, ptr %5, i64 10000
